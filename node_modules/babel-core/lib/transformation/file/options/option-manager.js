...
var OptionManager = (function () {
  ...
  OptionManager.prototype.addConfig = function addConfig(loc /*: string*/, key /*:: ?: string*/) /*: boolean*/ {
    ...
    this.mergeOptions(opts, this.options, loc, null, _path2["default"].dirname(loc));
  ...
  OptionManager.prototype.mergeOptions = function mergeOptions(rawOpts /*:: ?: Object*/, extendingOpts /*:: ?: Object*/, alias /*: string*/, loc /*:: ?: string*/, dirname /*:: ?: string*/) {
    ...
    if (opts.presets) {
      ...
      if (opts.passPerPreset) {
        opts.presets = this.resolvePresets(opts.presets, dirname, function (preset, presetLoc) {
          _this.mergeOptions(preset, preset, presetLoc, presetLoc, dirname);
        });
      } else {
    ...
    if (rawOpts !== extendingOpts) {
      _helpersMerge2["default"](extendingOpts, opts);
    } else {
  ...
  OptionManager.prototype.mergePresets = function mergePresets(presets /*: Array<string | Object>*/, dirname /*: string*/) {
    ...
    this.resolvePresets(presets, dirname, function (presetOpts, presetLoc) {
      _this2.mergeOptions(presetOpts, _this2.options, presetLoc, presetLoc, _path2["default"].dirname(presetLoc));
    });
  };
  ...
  OptionManager.prototype.init = function init() /*: Object*/ {
    ...
    this.mergeOptions(opts, this.options, "base", null, filename && _path2["default"].dirname(filename));
